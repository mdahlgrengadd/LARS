...
/***/ function(module, exports, __webpack_require__) {
	...
	var wavesAudio = __webpack_require__(165);
	...
	document.addEventListener('DOMContentLoaded', function () {
	    ...
	    var assets = ['./assets/footstomps_v2.json', './assets/piano_v2.json', './assets/3_4_guitar-loop_v2.json'];
	        ...
	        try {
	            var _loop = function _loop() {
	                ...
	                wavesurfer.on('ready', function () {
	                    ...
	                    var transportedObject = wavesurfer.backend.getTransported();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (f) {
	  if (( false ? "undefined" : _typeof4(exports)) === "object" && typeof module !== "undefined") {
	    module.exports = f();
	  } else if (true) {
	  ...
	  var define, module, exports;return function e(t, n, r) {
	    function s(o, u) {
	    ...
	    }, { "./_export": 65, "./_set-proto": 101 }], 125: [function (require, module, exports) {}, {}], 126: [function (require, module, exports) {
	      'use strict';
	      ...
	      (function (process) {
	        ...
	        function log() {
	          // this hackery is required for IE8/9, where
	          // the `console.log` function doesn't have 'apply'
	          return 'object' === (typeof console === "undefined" ? "undefined" : _typeof4(console)) && console.log && Function.prototype.apply.call(console.log, console, arguments);
	        }
	      ...
	      module.exports = function (val, options) {
	        options = options || {};
	        var type = typeof val === "undefined" ? "undefined" : _typeof4(val);
	        if (type === 'string' && val.length > 0) {
	          return parse(val);
	        } else if (type === 'number' && isNaN(val) === false) {
	          return options.long ? fmtLong(val) : fmtShort(val);
